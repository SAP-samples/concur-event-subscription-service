...
[![REUSE status](https://api.reuse.software/badge/github.com/SAP-samples/concur-event-subscription-service)](https://api.reuse.software/info/github.com/SAP-samples/concur-event-subscription-service)
